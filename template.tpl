                ...
                <div class="card card-theme">
                    ...
                    <div id="feed_{{dataid}}" class="collapse" aria-labelledby="heading-{{dataid}}@3">
                        <div class="fiche-list card-body">
                            ...
                            <a class="btn fiche-level-2 disabled" target="_blank" href="http://prod-kartensig3.cr-bretagne.fr/ws/kentika/fiche-article.php?code_siren={{dataid}}&page=1">Revue de presse (maintenance en cours...)</a>

                            <a class="btn fiche-level-2 disabled" target="_blank" href="https://kartenn.region-bretagne.fr/mreport/epci_actualites/{{dataid}}">Statistiques des articles </a>
