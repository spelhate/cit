<div class="card" data-filter="{{label}}">
    ...
    <div id="epci_{{dataid}}" class="collapse" aria-labelledby="heading-{{dataid}}">
        <div class="card-body">
            <a target="_blank" href="https://kartenn.region-bretagne.fr/fichenn/insee_2016/{{dataid}}">La population du
                territoire</a>
            ...
            <!--<a target="_blank" href="#" >L’engagement du territoire dans la Breizh Cop </a></div>-->
        </div>
    </div>
</div>